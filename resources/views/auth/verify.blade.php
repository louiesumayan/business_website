...
<head>
    ...
    <meta charset="utf-8" />
    <title>Verify | Tapeli - Responsive Admin Dashboard Template</title>
                    ...
                    <div class="row">
                        <div class="col-md-7 mx-auto">
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                ...
                                <div class="pt-0">
                                    <x-input-error :messages="$errors->get('code')" class="alert alert-danger" />
                                    <form action="{{ route('custom.verification.verify') }}" method="POST" class="my-4">
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="code" class="form-label">Verification code:</label>
                                            <input name="code" class="form-control" type="text" id="code" required=""
