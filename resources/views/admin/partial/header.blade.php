    ...
    <div class="container-xxl">
        <div class="d-flex justify-content-between">
            ...
            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                ...
                @php
                    $id = Auth::user()->id;
                    $profileUserData = App\Models\User::find($id);
                @endphp

                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button"
                        aria-haspopup="false" aria-expanded="false">
                        <img src="{{ !empty($profileUserData->photo) ? asset('backend/assets/upload/' . $profileUserData->photo) : asset('backend/assets/images/users/user-11.jpg') }}"
